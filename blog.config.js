...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://elderly-aquarius-0a7.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://elderly-aquarius-0a7.notion.site/api/v3
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '网络干饭人', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个干货满满的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.tao99.top', // 网站地址
